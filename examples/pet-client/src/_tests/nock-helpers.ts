...
export const Nock = {
     ...
     * uploads an image
       */
    uploadFile: (
queryParams: UploadFileNockParameters,  requestBody?:    RequestBodyMatcher,
  interceptorOptions?: Options & { preservePreviousInterceptors?: boolean }) : Omit<Interceptor, 'reply'> & {
    ...
    reply(
      replyFn: (
        ...
        uri: string,
        body: Body,
      ) => ReplyFnResultGeneric<IApiResponse> | Promise<ReplyFnResultGeneric<IApiResponse>>
    ): Scope
    reply(
      ...
      replyBodyFnWithCallback: (
        ...
        uri: string,
        body: Body,
        callback: (err: NodeJS.ErrnoException | null, result: IApiResponse) => void
      ) => void,
    ...
    reply(responseCode?: StatusCode, body?: IApiResponse, headers?: ReplyHeaders): Scope
} => {
...
(new RegExp('^' + url_), requestBody as RequestBodyMatcher, interceptorOptions);
     ...
     * Finds Pets by status
       */
    findPetsByStatus: (
queryParams: FindPetsByStatusNockParameters,  requestBody?:    RequestBodyMatcher,
  interceptorOptions?: Options & { preservePreviousInterceptors?: boolean }) : Omit<Interceptor, 'reply'> & {
	reply(
      replyFnWithCallback: (
        this: ReplyFnContext,
    ...
    reply(responseCode?: StatusCode, body?: Pet[], headers?: ReplyHeaders): Scope
} => {
...
,
     ...
     */
    findPetsByTags: (
queryParams: FindPetsByTagsNockParameters,  requestBody?:    RequestBodyMatcher,
  interceptorOptions?: Options & { preservePreviousInterceptors?: boolean }) : Omit<Interceptor, 'reply'> & {
	reply(
      replyFnWithCallback: (
        this: ReplyFnContext,
...
,
     ...
     * Find pet by ID
       */
    getPetById: (
queryParams: GetPetByIdNockParameters,  requestBody?:    RequestBodyMatcher,
  interceptorOptions?: Options & { preservePreviousInterceptors?: boolean }) : Omit<Interceptor, 'reply'> & {
	reply(
      replyFnWithCallback: (
        this: ReplyFnContext,
    ...
    reply(responseCode?: StatusCode, body?: IPet, headers?: ReplyHeaders): Scope
} => {
    let url_ = "/pet/{petId}";
        if (queryParams.petId !== null && queryParams.petId !== undefined)
          url_ = url_.replace("{petId}", encodeURIComponent("" + queryParams.petId));
...
(new RegExp('^' + url_), requestBody as RequestBodyMatcher, interceptorOptions);
     ...
     * Updates a pet in the store with form data
       */
    updatePetWithForm: (
queryParams: UpdatePetWithFormNockParameters,  requestBody?:    RequestBodyMatcher,
  interceptorOptions?: Options & { preservePreviousInterceptors?: boolean }) : Omit<Interceptor, 'reply'> & {
	reply(
      replyFnWithCallback: (
        this: ReplyFnContext,
...
(new RegExp('^' + url_), requestBody as RequestBodyMatcher, interceptorOptions);
     ...
     * Deletes a pet
       */
    deletePet: (
queryParams: DeletePetNockParameters,  requestBody?:    RequestBodyMatcher,
  interceptorOptions?: Options & { preservePreviousInterceptors?: boolean }) : Omit<Interceptor, 'reply'> & {
	reply(
      replyFnWithCallback: (
        this: ReplyFnContext,
    ...
    let url_ = "/pet/{petId}";
        if (queryParams.petId !== null && queryParams.petId !== undefined)
          ...
          url_ = url_.replace("{petId}", "");
    const interceptor = nock(getBaseUrl())
      .delete(new RegExp('^' + url_), requestBody as RequestBodyMatcher, interceptorOptions);
      if (!interceptorOptions?.preservePreviousInterceptors) {
        removeInterceptor(interceptor);
      }
      return interceptor as any;
  ...
  interceptorOptions?: Options & { preservePreviousInterceptors?: boolean }) : Omit<Interceptor, 'reply'> & {
    ...
    reply(
      replyFn: (
        ...
        uri: string,
        body: Body,
      ) => ReplyFnResultGeneric<{ [key: string]: number; }> | Promise<ReplyFnResultGeneric<{ [key: string]: number; }>>
    ): Scope
    reply(
      statusCode: StatusCode,
      replyBodyFnWithCallback: (
        ...
        uri: string,
        body: Body,
        callback: (err: NodeJS.ErrnoException | null, result: { [key: string]: number; }) => void
      ) => void,
      headers?: ReplyHeaders
    ): Scope
    reply(
    ...
    reply(responseCode?: StatusCode, body?: { [key: string]: number; }, headers?: ReplyHeaders): Scope
} => {
...
(new RegExp('^' + url_), requestBody as RequestBodyMatcher, interceptorOptions);
  ...
  interceptorOptions?: Options & { preservePreviousInterceptors?: boolean }) : Omit<Interceptor, 'reply'> & {
    ...
    reply(responseCode?: StatusCode, body?: IOrder, headers?: ReplyHeaders): Scope
} => {
...
(new RegExp('^' + url_), requestBody as RequestBodyMatcher, interceptorOptions);
     ...
     * Find purchase order by ID
       */
    getOrderById: (
queryParams: GetOrderByIdNockParameters,  requestBody?:    RequestBodyMatcher,
  interceptorOptions?: Options & { preservePreviousInterceptors?: boolean }) : Omit<Interceptor, 'reply'> & {
	reply(
      replyFnWithCallback: (
        this: ReplyFnContext,
    ...
    let url_ = "/store/order/{orderId}";
        if (queryParams.orderId !== null && queryParams.orderId !== undefined)
          url_ = url_.replace("{orderId}", encodeURIComponent("" + queryParams.orderId));
          else
          url_ = url_.replace("{orderId}", "");
    const interceptor = nock(getBaseUrl())
      .get
(new RegExp('^' + url_), requestBody as RequestBodyMatcher, interceptorOptions);
      if (!interceptorOptions?.preservePreviousInterceptors) {
     ...
     * Delete purchase order by ID
       */
    deleteOrder: (
queryParams: DeleteOrderNockParameters,  requestBody?:    RequestBodyMatcher,
  interceptorOptions?: Options & { preservePreviousInterceptors?: boolean }) : Omit<Interceptor, 'reply'> & {
	reply(
      replyFnWithCallback: (
        this: ReplyFnContext,
...
(new RegExp('^' + url_), requestBody as RequestBodyMatcher, interceptorOptions);
     ...
     * Get user by user name
       */
    getUserByName: (
queryParams: GetUserByNameNockParameters,  requestBody?:    RequestBodyMatcher,
  interceptorOptions?: Options & { preservePreviousInterceptors?: boolean }) : Omit<Interceptor, 'reply'> & {
	reply(
      replyFnWithCallback: (
        this: ReplyFnContext,
    ...
    reply(responseCode?: StatusCode, body?: IUser, headers?: ReplyHeaders): Scope
} => {
    let url_ = "/user/{username}";
        if (queryParams.username !== null && queryParams.username !== undefined)
          url_ = url_.replace("{username}", encodeURIComponent("" + queryParams.username));
          else
          url_ = url_.replace("{username}", "");
    const interceptor = nock(getBaseUrl())
      .get
(new RegExp('^' + url_), requestBody as RequestBodyMatcher, interceptorOptions);
      if (!interceptorOptions?.preservePreviousInterceptors) {
     ...
     * Updated user
       */
    updateUser: (
queryParams: UpdateUserNockParameters,  requestBody?:    | string
    | Buffer
    | RegExp
    | DataMatcherArray
    | DataMatcherMap
...
(new RegExp('^' + url_), requestBody as RequestBodyMatcher, interceptorOptions);
     ...
     * Delete user
       */
    deleteUser: (
queryParams: DeleteUserNockParameters,  requestBody?:    RequestBodyMatcher,
  interceptorOptions?: Options & { preservePreviousInterceptors?: boolean }) : Omit<Interceptor, 'reply'> & {
	reply(
      replyFnWithCallback: (
        this: ReplyFnContext,
     ...
     * Logs user into the system
       */
    loginUser: (
queryParams: LoginUserNockParameters,  requestBody?:    RequestBodyMatcher,
  interceptorOptions?: Options & { preservePreviousInterceptors?: boolean }) : Omit<Interceptor, 'reply'> & {
	reply(
      replyFnWithCallback: (
        this: ReplyFnContext,
